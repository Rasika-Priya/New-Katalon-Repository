...
WebUI.click(findTestObject('Object Repository/login/Page_Login/span_Username is required'))

WebUI.verifyElementText(findTestObject('Object Repository/login/Page_Login/span_Username is required'), 'Username is required')
